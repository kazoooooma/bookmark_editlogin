...
if($status==false) {
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){ 
    ...
    '<a href="" onclick="delClick('.$result['id'].')">[投稿を削除]</a></td>'.
...
<header>
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <div class="listlink"><a class="linktext" href="user_list_view.php">ユーザ-管理</a></div>
    </div>
  </nav>
</header>
<!-- Head[End] -->
...
<div class="title-container">
    <p class="title-text">ブックマーク一覧（管理者ページ）</p>
  </div>
<div>
<table class="list_table">
    <tr>
      ...
      <th class="list_header" id="edit">編集</th>
    </tr>
    <?= $view ?>
</div>
<!-- Main[End] -->
...
<script>
  function delClick(id){
    ...
    if( res == true ) {
        // OKなら移動
        window.location.href = "https://kazoooooma.sakura.ne.jp/bookmark_editlogin/bm_delete.php?id="+id;
    }
    else {
        // キャンセルならアラートボックスを表示
        alert("キャンセルしました");
